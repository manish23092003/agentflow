...
export function createPayingClient() {
  ...
  if (!mnemonic) {
    throw new Error(
      'X402_CLIENT_MNEMONIC is missing. Use only a disposable demo wallet, funded with ALGO and opted into USDC.',
    );
  }
